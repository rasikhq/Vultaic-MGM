...
function cmd_vr_dm(player, command)
	if isPlayerInArena(player) then
		...
		local redoGoal = math.ceil(#arena.players*0.65)
...
addCommandHandler("vr", cmd_vr_dm)
